...
], function( $, _, Backbone )
{
    return Backbone.View.extend(
    {
         ...
         * Get Template
         *
         * Checks if template id has been defined. If so, checks if a template
         * has already been compiled. If yes, the compiled template function is
         ...
         *  Renders the view based on its template.
         *
